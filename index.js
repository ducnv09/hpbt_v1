...
const texts = [
  "Happy birthday cô nàng! 🥳🔥",
  "Chúc cậu tuổi mới tràn đầy niềm vui, xinh đẹp rạng rỡ, thành công luôn bay cao nha! 😎✨",
];
...
function typeWriter(texts, element, textIndex = 0, i = 0) {
    if (textIndex < texts.length) {
        ...
        setTimeout(() => typeWriter(texts, element, textIndex, i + 1), 20); // Tốc độ gõ
        } else {
        setTimeout(() => {
